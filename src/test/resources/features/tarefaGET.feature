Feature: Tarefa GET
  ...
  Scenario: obter uma tarefa com sucesso
    Given que possuo uma tarefa cadastrada
  ...
  Scenario: obter uma tarefa com arquivos cadastrados com sucesso
    Given que possuo um projeto com uma tarefa com arquivos cadastrados
  ...
  Scenario: nao obter uma tarefa com arquivos cadastrados com sucesso
    Given que possuo um projeto cadastrado que nao contem arquivos
